...
user_email = "user@example.com" #sys.argv[1] #"user@example.com"
attempt_id = "1"#sys.argv[2] #"1"
project = "python_problem1" #sys.argv[3] #"python_problem1"

# Task weightage
task_weightage = {
    "load_the_dataset": 3, "get_name_value_counts": 2, "get_city_value_counts": 2,
    "missing_value_check": 2.5, "missing_value_treatment": 2.5, "box_plot1": 0.5,
    "treat_outliers_iqr": 2, "box_plot2": 0.5, "clean_car_sales_data": 1, "corr": 3,
    "perform_anova": 5, "seller_type_influence_test": 5, "chi_square_test": 5,
    "drop_var1": 3, "city_region": 2, "drop_var2": 1, "encode_categorical_columns": 2,
    "save_file": 0.5, "load_the_cleaned_dataset": 1, "separate_data_and_target": 1,
    "split_into_train_and_test_normalize_features": 4, "multicollinearity": 4,
    "fit_the_model_ols": 10, "fit_the_model_on_the_training_data": 10,
    "ols_calculate_rmse_r2": 2, "test_the_sklearn_model": 2,
    "calculate_r_squared_sklearn": 3, "calculate_rmse_sklearn": 3,
    "drop_variables": 1, "target_transform": 1, "separate_data_and_target_new": 2,
    "split_into_train_and_test_normalize_features_2": 5,
    "fit_the_model_on_the_training_data_2": 10, "test_the_finalmodel": 5,
    "calculate_r_squared_finalmodel": 3, "calculate_rmse_finalmodel": 3
}
...
def compare_outputs(problem_df, solution_df, task_weightage):
    ...
    for _, row in problem_df.iterrows():
        ...
        if solution_output and problem_output and problem_output.strip() == solution_output.strip():
            score = task_weightage.get(function_name, 0)
            remark = "Success"
        else:
            score = 0
            remark = problem_output if problem_output else "Missing or not executed"
...
# --- Step 2: Compare outputs and score ---
...
# --- Step 4: Handle visual function comparison ---
...
# --- Final output ---
final_df = merged_df[['UserEmail','attempt_id','method_name','score_gained','max_score','timestamp','remarks','project']]
final_df
